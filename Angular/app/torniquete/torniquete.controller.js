/**
 * @desc Controlador TorniqueteController.
...
(function() {
    ...
    angular
        .module('stockLaboratorioApp.torniquete')
        .controller('TorniqueteController', TorniqueteController);

    TorniqueteController.$inject = ['$scope', '$http'];

    function TorniqueteController($scope, $http) {
        ...
        /* –––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
         * Solicita todos los grupos sanguíneos al archivo torniquete.php y los
         * guarda en el array matrizGruposSanguineos.
         */
        $http
            .get('app/torniquete/torniquete.php?action=obtener-grupos-sanguineos')
            .then(function(response) {
                $scope.matrizGruposSanguineos = response.data;
                //console.log('Grupo Sanguineo[0]: ' + response[0].gru_nombre);
            }, function(response) {
                console.log('Error en torniquete.controller.js (estado ' + response.status + ' ' + response.statusText + ').');
        });    
        
        /* –––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
         * Solicita las frecuencias de donación (3, 4 ó 6 meses) al archivo
         * torniquete.php y las guarda en el array matrizFrecuenciasDeDonacion.
         */
        $http
            .get('app/torniquete/torniquete.php?action=obtener-frecuencias-de-donacion')
            .then(function(response) {
        ...
        /* –––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
         * Envía el objeto persona al archivo torniquete.php para agregar una
         * nueva persona.
         */
        $scope.agregarPersona = function() {
            //console.log('Persona para agregar: ' + $scope.persona.nombre);
            $http
                .post('app/torniquete/torniquete.php?action=agregar-persona', $scope.persona)
                .then(function() {
