/**
 * @desc Controlador AgujaController.
...
(function() {
    ...
    angular
        .module('stockLaboratorioApp.aguja')
        .controller('AgujaController', AgujaController);

    AgujaController.$inject = ['$scope', '$http'];

    function AgujaController($scope, $http) {
        ...
        /* –––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
         * Solicita todos los grupos sanguíneos al archivo aguja.php y los
         * guarda en el array matrizGruposSanguineos.
         */
        $http
            .get('app/aguja/aguja.php?action=obtener-grupos-sanguineos')
            .then(function(response) {
                $scope.matrizGruposSanguineos = response.data;
                //console.log('Grupo Sanguineo[0]: ' + response[0].gru_nombre);
            }, function(response) {
                console.log('Error en aguja.controller.js (estado ' + response.status + ' ' + response.statusText + ').');
        });    
        
        /* –––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
         * Solicita las frecuencias de donación (3, 4 ó 6 meses) al archivo
         * aguja.php y las guarda en el array matrizFrecuenciasDeDonacion.
         */
        $http
            .get('app/aguja/aguja.php?action=obtener-frecuencias-de-donacion')
            .then(function(response) {
        ...
        /* –––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––
         * Envía el objeto persona al archivo aguja.php para agregar una
         * nueva persona.
         */
        $scope.agregarPersona = function() {
            //console.log('Persona para agregar: ' + $scope.persona.nombre);
            $http
                .post('app/aguja/aguja.php?action=agregar-persona', $scope.persona)
                .then(function() {
