/**
 * @desc Controlador guanteController.
...
(function() {
    ...
    angular
        .module('stockLaboratorioApp.guante')
        .controller('GuanteController', GuanteController);

    GuanteController.$inject = ['$scope', '$http'];

    function GuanteController($scope, $http) {
