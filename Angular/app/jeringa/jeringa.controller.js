/**
 * @desc Controlador JeringaController.
...
(function() {
    ...
    angular
        ...
        .controller('JeringaController', JeringaController);

    JeringaController.$inject = ['$scope', '$http'];

    function JeringaController($scope, $http) {
