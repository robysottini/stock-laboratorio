...
(function() {
    ...
    angular
        ...
        .controller('ReactivoDatepickerController', ReactivoDatepickerController);

    ReactivoDatepickerController.$inject = ['$scope'];

    function ReactivoDatepickerController($scope) {
