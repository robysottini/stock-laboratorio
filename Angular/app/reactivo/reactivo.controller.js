/**
 * @desc Controlador ReactivoController.
...
(function() {
    ...
    angular
        .module('stockLaboratorioApp.reactivo')
        .controller('ReactivoController', ReactivoController);

    ReactivoController.$inject = ['$scope', '$http'];

    function ReactivoController($scope, $http) {
