/**
 * @desc Controlador ComprimidoController.
...
(function() {
    ...
    angular
        .module('stockLaboratorioApp.comprimido')
        .controller('ComprimidoController', ComprimidoController);

    ComprimidoController.$inject = ['$scope', '$http'];

    function ComprimidoController($scope, $http) {
