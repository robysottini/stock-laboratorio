...
(function() {
    ...
    angular
        ...
        .controller('ComprimidoDatepickerController', ComprimidoDatepickerController);

    ComprimidoDatepickerController.$inject = ['$scope'];

    function ComprimidoDatepickerController($scope) {
